...
#
# Building is all this does. Publishing belongs to .github/workflows/docs.yml,
# which runs this script and hands the output to GitHub Pages as an artefact --
# so the generated HTML is never committed anywhere and this project has one
# branch.
