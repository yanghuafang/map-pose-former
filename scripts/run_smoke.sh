...
# run_smoke.sh -- train, evaluate and draw, on generated data, in minutes.
#
...
# localizer -- a few hundred steps on twenty-four scenes cannot -- it produces
# a loss that fell, a checkpoint that loads, and an SVG worth looking at.
...
python tools/viz_sample.py --index 30 --out "${out}/sample.svg"
