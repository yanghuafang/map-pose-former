...
#
#   ./scripts/download_nuscenes.sh           # 1.6 GB: the map, which is all
#                                            # the first half of M5 needs
...
#
# The blobs matter for the second half of M5, where a pretrained mapper --
# MapTR or StreamMapNet --
...
# stood, and --help reads this file back with awk after moving.
